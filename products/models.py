...
class Bike(models.Model):
    ...
    created_at = models.DateTimeField(default=timezone.now)
    color = models.ForeignKey(ColorVariant, on_delete=models.PROTECT, null=True, blank=True)
...
class BikeImages(models.Model):
    bike = models.ForeignKey(Bike, related_name='images', on_delete=models.PROTECT)
